...
namespace UPR.PredictionRollback
{
    ...
    {
        public static ICommandTimeline<TCommand> AppendRepeatPrediction<TCommand>(this ICommandTimeline<TCommand> commandTimeline) where TCommand : IEquatable<TCommand>
        {
        ...
        public static ICommandTimeline<TCommand> AppendFadeOutPrediction<TCommand>(this ICommandTimeline<TCommand> commandTimeline, int startDecayTick = 30, int decayDurationTicks = 60)
            where TCommand : IFadingOutCommand<TCommand>, IEquatable<TCommand>
        {
